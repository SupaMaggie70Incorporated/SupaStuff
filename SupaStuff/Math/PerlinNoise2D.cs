...
namespace SupaStuff.Math
{
    public class PerlinNoise2D
    {
        ...
        public PerlinNoise2D(byte seed, float frequency = 0.1f, int depth = 4)
        {
            Seed = seed;
            Frequency = frequency;
            Depth = depth;
        }
        public PerlinNoise2D(float frequency = 0.1f,int depth = 4)
        {
            Seed = RandByte();
            Frequency = frequency;
            Depth = depth;
        ...
        public static float Get(float x,float y,float frequency = 0.1f,int depth = 4,int seed = 0)
        {
